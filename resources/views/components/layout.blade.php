...
<div class="min-h-full">
  ...
  <header class="relative bg-white shadow-sm">
    ...
    <a class="border border-emerald-600 px-4 py-2 rounded-full hover:bg-emerald-600 transition font-medium text-md hover:text-white" href="/jobs/create">Create Job</a>  
    </div>
  </header>
  <main>
